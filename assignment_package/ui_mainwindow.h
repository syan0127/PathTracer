...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        photonSpinBox->setMinimum(0);
        photonSpinBox->setMaximum(1000000);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        integratorSpinBox->insertItems(0, QStringList()
         ...
         << QApplication::translate("MainWindow", "Photon Mapping", Q_NULLPTR)
        );
        ...
        label_4->setText(QApplication::translate("MainWindow", "Photon count:", Q_NULLPTR));
        label_5->setText(QApplication::translate("MainWindow", "Search radius", Q_NULLPTR));
